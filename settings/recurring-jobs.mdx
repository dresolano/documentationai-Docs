...
The very first child job in a recurring series automatically includes a **First-Service Setup** line item in its Job Value card. This one-time line item helps you account for initial setup costs, such as a deep clean or on-site walkthrough. Subsequent child jobs do not include this line item.
