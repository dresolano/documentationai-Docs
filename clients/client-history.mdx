...
The page title shows the client's name with a Commercial or Residential account type badge next to it. If a primary contact name has been added, it appears directly beneath the title.

A contact info card shows the client's email address, phone number, and service location. The section label reads **Service location** for Commercial accounts and **Service address** for Residential accounts.

If notes have been added for the client, a notes card appears on the page. The card title reads **Facility Notes** for Commercial accounts and **Client Notes** for Residential accounts. The notes card only shows when saved notes exist.
