...
All metrics on the dashboard can be filtered by client account type. Use the **Client account type** dropdown to view metrics for **Commercial** clients only, **Residential** clients only, or **All clients**. This lets you compare performance across account types — for example, checking whether issue rates differ between commercial and residential work.
